Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/1642a2557cef1874999606fe20057deb"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(0.0 /*_MainTexUV*/)].xy, float4(10,0.2,0,0));
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(10,1,0,0)), float4(0,0,0,0), (1.0 /*_BumpMapStochastic*/)), (1.5 /*_BumpScale*/));
				#else
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.673178,0.673178,0.673178,1).rgb, (0.0 /*_ColorThemeIndex*/));
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, pow(abs(poiFragData.baseColor), (0.07 /*_MainGamma*/)), hueShiftAlpha.a);
				...
				poiFragData.baseColor = saturate(lerp(poiFragData.baseColor, poiFragData.baseColor * ((-0.3 /*_MainBrightness*/) + 1), hueShiftAlpha.g));
				#endif
